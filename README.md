...
In this project, measurements from LiDAR and camera are fused and vehicles are tracked over time. Real-world data from the Waymo Open Dataset is used, objects in 3D point clouds are detected and an extended Kalman filter for sensor fusion and tracking is applied.
...
### Python
The project has been written using Python 3.8.12. Please make sure that your local installation is equal to this version. 
